...
// Service slider
const wrapper = document.querySelector(".service");
...
function blur_overflown_elements() {
    // console.log("no");
    wrapper.querySelectorAll('.service-box').forEach(function(element){
        var container_startX = container.getBoundingClientRect()['x'];
        var container_endX = container_startX + container.getBoundingClientRect()['width'];
        var main_width = element.getBoundingClientRect()['width'];
        var startX = element.getBoundingClientRect()['x'];
        var endX = startX + main_width;
        if(startX < container_startX-15 || endX > container_endX+15) {
...
function blur_overflown_elements_left() {
  ...
  wrapper.querySelectorAll('.service-box').forEach(function(element){
      ...
      var startX = element.getBoundingClientRect()['x'];
      var endX = startX + main_width;
      if(startX < container_startX - main_width-15 || endX > container_endX - main_width+15) {
          element.classList.add('overflown');
      }
      else {
          element.classList.remove('overflown');
...
function blur_overflown_elements_right() {
  // console.log("no");
  wrapper.querySelectorAll('.service-box').forEach(function(element){
      var container_startX = container.getBoundingClientRect()['x'];
      var container_endX = container_startX + container.getBoundingClientRect()['width'];
