...
document.addEventListener("DOMContentLoaded", function() {
    const carousel = document.querySelector(".service");
    const arrowBtns = document.querySelectorAll(".service-wrapper i");
    const wrapper = document.querySelector(".service-wrapper");

    const firstCard = carousel.querySelector(".service-box");
    ...
    arrowBtns.forEach(btn => {
        btn.addEventListener("click", () => {
            carousel.scrollLeft += btn.id === "service-left" ? 
