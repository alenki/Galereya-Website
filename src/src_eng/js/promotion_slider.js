  ...
  await promotion_slides.getPromotionSlides().then(promotion_slides => {
    ...
    var promotion_amount = 0;
      ...
      promotion_slides.forEach(promotion_slides => {
        ...
        // Add sliders
        promotion1_result+=`
        <a href="${promotion_slides.url}" target="_blank" class="promotion-box_Mobile" id="${promotion_slides.id}" aria-label="${promotion_slides.englishTitle}">
          <img src="${promotion_slides.image}" class="promo-img" alt="${promotion_slides.englishTitle}" id="${promotion_slides.id}">
        </a>
        `
      });
      ...
      promotion_slides.forEach(promotion_slides => {
        // Add sliders
        promotion2_result+=`
      <a href="${promotion_slides.url}" target="_blank" class="promotion-box" id="${promotion_slides.id}" aria-label="${promotion_slides.englishTitle}">
            <img src="${promotion_slides.image}" class="promo-img" alt="${promotion_slides.englishTitle}" id="${promotion_slides.id}">
      </a>
        `
      });
