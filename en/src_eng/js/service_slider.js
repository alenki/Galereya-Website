    ...
    var service_amount = 0;
      service_slides.forEach(service_slides => {
        ...
        <div class="service-box_Mobile service-onclick" id="${service_slides.id}">
          ...
          <span class="service-name_Mobile service-onclick" id="${service_slides.id}">${service_slides.englishTitle}</span>
        </div>
        `
      });
      ...
      service_slides.forEach(service_slides => {
        ...
        <div class="service-card service-onclick" id="${service_slides.id}">
          ...
          <span class="service-name service-onclick" id="${service_slides.id}">${service_slides.englishTitle}</span>
        </div>
      </div>
        `
      });
